        ...
        <SectionContainer>
            <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                ...
                <SubmitImageContainer>
                    {errors.image?.ref && !previewImage.img && < span style={{ color: 'red', paddingLeft: '1rem' }}> *Sem imagem selecionada!</span>}
                    {isSubmitted.error && <span style={{ color: 'red', paddingLeft: '1rem' }}> *Senha inválida!</span>}
                    {isSubmitted.submitted && !isSubmitted.error && !errors.image?.ref && <span style={{ color: 'green', paddingLeft: '1rem' }}> Imagem enviada!</span>}
